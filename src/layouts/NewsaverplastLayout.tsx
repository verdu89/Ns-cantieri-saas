        ...
        {mobileOpen && (
          <div className="fixed inset-0 z-50 flex md:hidden">
            ...
            <motion.aside
              ...
              animate={{ x: 0 }}
              exit={{ x: -250 }}
              className={`w-80 ${navSidebarPanelClass(navTheme)}`}
            >
              <div>
                <button
                  type="button"
                  className="mb-4 flex items-center gap-2 rounded-xl px-2 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-100 dark:text-gray-300 dark:hover:bg-gray-700"
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
          ...
          <header
            className={cn(
              ...
              "z-30 min-h-0 shrink-0 gap-2 py-2 md:py-3",
              isNative && "pt-[env(safe-area-inset-top,0px)]"
            )}
          >
            <button
              type="button"
