...
export default function JobCheckoutModal({
  ...
  const confirmCheckout = async () => {
    ...
    try {
      ...
      if (checkoutResult.orderOfficeCloseOutcome === "insolute") {
        footnotes.push({
          id: "office-insolute",
          text: "Commessa insoluta passata a Terminate ma insolute",
        });
      } else if (checkoutResult.orderOfficeCloseOutcome === "settled") {
        footnotes.push({
          id: "office-settled",
          text: "Commessa passata a Terminate e consegnate",
        });
      }
